...
window.MENU_REQUESTS = {
 "version": 847,
 "updatedAt": "2026-08-21 18:45",
 "days": 30,
 "items": [
  {
   "ts": "1787305159.854719",
   "date": "2026-08-21",
   "time": "18:39",
   "store": "카페911커피",
   "biz": "8791201918",
   "pos": "퍼스트포스",
   "content": "모든 메뉴 핫 음료에는 사이즈선택 모두 삭제해주세요(뜨거운음료는 기본 16온즈로 통일이므로)\n\n아이스에는 구조16온즈를 삭제해주시고 2가지 사이즈만 표기해주세요 \n긴급24온즈3샷 ₩1,000원 과\nCPR(1리터)4샷 ₩2,000원\n\n청포도에이드 5,000에서 4,500원으로 변경\n오레오초코쉐이크 4,000에서 4500으로 변경\n\n새로운 카테고리생성해 주세요\n(선택넣지 말아주세요 기본16온즈로만)\n911에너지 드링크\n911행오버헬퍼 4,000\n911슈퍼파워 4,000",
   "special": "빠르게 변경 부탁드립니다",
   "drive": [],
   "files": 0,
   "att": [],
   "datt": [],
  ...
  },
  {
   ...
   "replies": [],
   "rc": 1,
   "lr": "1787295811.928679",
   "rfx": 3,
   "status": "done",
   "handler": "김규빈",
   "link": "https://w1659946222-hxm266180.slack.com/archives/C08740SFT1S/p1787295808242849"
  },
  {
  ...
  {
   "ts": "1787290841.977459",
   "date": "2026-08-21",
   "time": "14:40",
   "store": "쭈닭한상",
   "biz": "7822301997",
   "pos": "토스포스",
   "content": "부추비빔밥 (쭈삼) 10,900  추가",
   "special": "",
   "drive": [],
   "files": 0,
   "att": [],
